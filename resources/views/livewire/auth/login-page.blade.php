          ...
          <div class="p-4 sm:p-7">
            ...
            <form wire:submit.prevent="save">
                <div class="grid gap-y-4">
                    ...
                    @if(session('error'))
                    <div class="mt-2 bg-red-100 border mb-2 border-red-200 text-sm text-red-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500" role="alert">
                        {{session('error')}}
                      </div>
                    @endif
                    <div>
