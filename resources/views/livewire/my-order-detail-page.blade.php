            ...
            @php
                $status = '';
                    ...
                    if ($order->status =='shipped') {
                       $status ='<span class="bg-green-700 py-1 px-3 rounded text-white shadow">Shipping</span>';
                    }
                    if ($order->status =='delivered') {
                       $status ='<span class="bg-green-400 py-1 px-3 rounded text-white shadow">Delivered</span>';
                    }
            ...
            @php
                ...
                $payment_status = '';
                    ...
                    if ($order->payment_status =='pending') {
                       $payment_status ='<span class="bg-red-600 py-1 px-3 rounded text-white shadow">Pending</span>';
                    }
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <table class="w-full">
            ...
            <tbody>
                ...
                <tr> <tr wire:key="{{$items->id}}">
                    <td class="py-4">
                      <div class="flex items-center">
                        <img class="h-16 w-16 mr-4" src="{{ url('storage', $items->product->image[0]) }}" alt="{{$items->product->name}}">
                        <span class="font-semibold">{{$items->product->name}}</span>
                      </div>
                    </td>
                    ...
                    <td class="py-4">{{Number::currency($items->total_amount, 'IDR')}}0</td>
                  </tr>
