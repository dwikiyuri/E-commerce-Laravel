    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">YuriGshop</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase a wide variety of gaming products like PC Gaming, Mouse, Keyboards, Headsets, and many more.</p>
      ...
      <section class="py-20">
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2 ">
            ...
            <div class="bg-transparent rounded-lg" wire:key='{{$brand->id}}'>
                <a href="/products?selected_brands[0]={{$brand->id}}" class="block">
                    <div class="flex justify-center items-center h-10md:h-40">
                        <img src="{{ url('storage', $brand->image) }}" alt="{{ $brand->name }}" class="object-contain bg-transparent  w-32 h-32 md:w-40 md:h-40">
                    </div>
                </a>
            </div>
      ...
      <div class="bg-orange-200 py-20">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
            ...
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products?selected_categories[0]={{$catg->id}}" wire:key="{{$catg->id}}">
                <div class="p-4 md:p-5">
                  <div class="flex justify-between items-center">
                    <div class="flex items-center">
                      <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ url('storage', $catg->image)}}" alt="Image Description">
                      <div class="ms-3">
