          ...
          <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->image[0]) }}' }">
            <div class="sticky top-0 z-1 overflow-hidden ">
              ...
              <div class="flex-wrap hidden md:flex ">
                ...
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ url('storage', $value) }}'">
                    <img src="{{ url('storage', $value) }}" alt="{{ $product->name }}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                  </div>
                @endforeach
            ...
            <div class="lg:pl-20">
              ...
              <div class="w-32 mb-8 ">
                ...
                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                  ...
                  <input type="" wire:model='quantity' readonly class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="1">
